...
from dash_apps.charts.eu_plotly_choropleth_chart import eu_plotly_choropleth_chart
from dash_apps.charts.eu_plotly_racing_bar import eu_plotly_racing_bar_chart


class DashAppEU:
    def __init__( self, flask_server ):
        self.app = Dash( name=self.__class__.__name__,
                         routes_pathname_prefix='/dash_app_eu/',
        ...
        self.question_list.append(
            'Environmental taxes in the EU from 2010 to 2017' )
        self.question_list.append(
            'Rankings of EU countries in Annual Greenhouse Gas Emission from 2010 to 2017' )
        self._fig1 = eu_plotly_choropleth_chart()
        self._fig2 = eu_plotly_racing_bar_chart()
